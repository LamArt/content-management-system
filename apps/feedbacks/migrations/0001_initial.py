    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_avatar', models.ImageField(blank=True, null=True, upload_to='images/%Y/%m/%d/', verbose_name='Аватар')),
                ('feedback_text', models.TextField(max_length=1024, verbose_name='Текст отзыва')),
                ('video', models.URLField(blank=True, null=True, verbose_name='Видеоролик')),
                ('source_name', models.CharField(blank=True, max_length=256, null=True, verbose_name='Название источника')),
                ('source_link', models.URLField(blank=True, null=True, verbose_name='Источник отзыва')),
                ('employees', models.ManyToManyField(blank=True, to='employees.employee', verbose_name='Сотрудники')),
