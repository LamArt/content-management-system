...
from apps.company_description.models import PatientInfo
...
class PatientInfoTests(TestCase):
    ...
    def test_patient_info_create(self):
        ...
        self.assertTrue(isinstance(patient_info, PatientInfo))
        self.assertEqual(len(PatientInfo.objects.all()), 1)
